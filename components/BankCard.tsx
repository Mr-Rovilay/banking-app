  ...
  return (
    <div className='flex flex-col'>
        ...
        <div className="bank-card_content">
            ...
            <article className='flex flex-col gap-2'>
              <div className="flex justify-between">
                <h1 className='text-12 font-semibold text-white capitalize'>{userName}</h1>
        ...
        <div className="bank-card_icon">
          ...
          <Image src={"/icons/lines.png"} width={20} height={24} alt='lines' className='absolute top-0 left-0'/>
        </div>
        </Link>
    </div>
  )
